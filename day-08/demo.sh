...
note "Поставщик сам называет предел: 1 048 576 токенов. В ответе 400 нет ни поля usage, ни ответа — по нему о тарификации сказать нельзя ничего; баланс до и после не изменился."
